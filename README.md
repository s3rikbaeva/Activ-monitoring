...
<br />
<h3>Also you can add our project to SQLite using next commands: </h3> <a href="/docs/query_optimization/commands.txt">commands</a>
<br />
<h3>For every functionality query, we write analysis and also added screenshots of runtime executions:</h3>
